# Проект домашней работы курса SkyPro
...
main - алгоритмическая последовательность сортировки и вывода запрашиваемых данных о транзакциях.
модуль состоит из 3 функций:    
    read_transactions - функция чтения
    filter_and_sort_transactions - функция фильтрации и сортировки
    display_transactions - функция последовательного отображения и вывода
...
get_transactions_json - Функция чтения и парсинга файла с транзакциями
