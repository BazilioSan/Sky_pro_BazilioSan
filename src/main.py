...
def read_transactions():
    """Функция чтения файлов с данными в зависимости от выбора пользователя"""
...
def filter_and_sort_transactions(transactions):
    """Функция сортировки и фильтрации полученных данных"""
    ...
    while True:
        ...
        if status in ["EXECUTED", "CANCELED", "PENDING"]:
            ...
            print(f"Статус операции '{status}' недоступен. Повторите ввод")
